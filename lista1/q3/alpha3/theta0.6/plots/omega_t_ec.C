...
//=========  (Tue Dec 14 00:03:21 2021) by ROOT version 6.22/00
   ...
   c->Range(-4.323,-0.3818743,38.907,0.3818743);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   0.1110569,
   0.1183461};
   TGraph *graph = new TGraph(787,Graph0_fx65,Graph0_fy65);
   graph->SetName("Graph0");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetMarkerStyle(3);
   
   TH1F *Graph_Graph065 = new TH1F("Graph_Graph065","",787,0,34.584);
   Graph_Graph065->SetMinimum(-0.3054995);
   Graph_Graph065->SetMaximum(0.3054995);
